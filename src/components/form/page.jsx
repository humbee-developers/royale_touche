...
import form_image1 from "@/images/Blockboard_contactusImage.jpg"
import { ContactFormSchemas } from "@/components/schemas/page";
import "./form.css";
const Contactform = () => {
  const router = useRouter()
  const location1 = usePathname()
  console.log("Current pathname:", location1);

  const showComponent  = location1 === '/product/blockboard';
  ...
  return (
    ...
    {showComponent && (
      <Image src={form_image1} alt="none" className={styles.form_image} />
    )}
    {!showComponent && (
